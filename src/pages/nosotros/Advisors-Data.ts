...
import imgAdvisor9 from '@assets/colaboradoresNosotros/Yoloxochitl.jpeg'
import imgAdvisor10 from '@assets/colaboradoresNosotros/Talien.jpeg'
...
export const ADVISORS: Advisor[] = [
  ...
  {
    name: "Yoloxóchitl Corona Ruelas",
    degrees: [
      "Lic. en Sociología",
      "Mtra. en Ciencia Política",
      "Dra. en Ciencias Sociales",
    ],
